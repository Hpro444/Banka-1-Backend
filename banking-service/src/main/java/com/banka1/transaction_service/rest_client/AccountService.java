 ...
 */
@Service("transactionAccountServiceAdapter")
...
public class AccountService {
    ...
    // AccountDetailsResponseDto here only has one field: vlasnik (mapped from JSON "ownerId")
    public AccountDetailsResponseDto getDetails(String accountNumber) {
        ...
        return new AccountDetailsResponseDto(r.ownerId());
    }
}
